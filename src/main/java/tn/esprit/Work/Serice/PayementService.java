...
import tn.esprit.Work.IService.IServicePayement;
...
import tn.esprit.Work.Repository.PayementRepository;
...
public class PayementService implements IServicePayement {
	@Autowired
	PayementRepository payementRepository;
	@Autowired
	IServicePublicite servicePublicite ;
	@Autowired
	IServiceColloboration serviceCollab;
  
	@Override
	public Payement addPayement(Payement payement,long idu,long idp) {
		
		Collaborateur u = serviceCollab.findCollobrationById(idu);
		Publicite p = servicePublicite.findPubById(idp);
		payement.setUser(u);
		payement.setPublicite(p);
		payement.setAmount(p.getMontant());
		payement.setPayementType(PayementType.Online);
	...
	@Override
	public List<Payement> retriveAllPayment() {
